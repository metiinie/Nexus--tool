            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div>
                    <h2 className="text-4xl font-black text-white flex items-center gap-4 uppercase italic tracking-tighter">
                        <Trophy className="text-amber-400 w-10 h-10" /> Trophy Room
                    </h2>
                    <p className="text-[11px] text-slate-400 font-mono tracking-[0.3em] mt-2 ml-1 opacity-60 uppercase">Vanguard Achievement Protocol</p>
                </div>
                ...
                <GlassCard className="px-6 py-4 bg-slate-950/40 border-white/5 min-w-[240px]">
                    ...
                    <div className="mt-2 text-[9px] text-slate-600 font-bold uppercase tracking-tighter text-right">
                        {unlockedCount} / {totalCount} Records Neutralized
                    </div>
                </GlassCard>
            </div>
                            ...
                            >
                                ...
                                {isUnlocked && (
                                    <div className="mt-6 flex items-center gap-2">
                                        ...
                                        <span className="text-[9px] font-mono text-amber-500/50 uppercase tracking-widest font-black italic">Record Verified</span>
                                    </div>
                                )}
                            </GlassCard>
                        </motion.div>
